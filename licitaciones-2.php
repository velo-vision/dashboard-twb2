                ...
                <div class="col-xs-12 col-md-12 bottom-100">
                    <div class="box-header">
                      <div class="box-footer1">
                        <div class="col-xs-12 col-md-12 col-xs-12 top-20 botton-volver">
                          <div class="col-xs-1 col-sm-3 col-md-4 prev-next nomargin">
                          </div>
                          <div class="col-xs-12 col-sm-6 col-md-4 centers nomargin">
                            <a href="proveedores-editar.php"><p type="submit" class="btn boton-responder"><i class="fa fa-envelope-open-o" aria-hidden="true"></i>&nbsp; Responder</p></a>
                          </div>
                          <div class="col-xs-1 col-sm-3 col-md-4 prev-next1 nomargin">
                          </div>
                        </div>
                      </div>
                    </div>
