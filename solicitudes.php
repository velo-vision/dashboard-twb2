      ...
      <div>
        <div class="col-md-8 col-md-offset-2">
          <ul class="nav nav-tabs tabs-proveedor" role="tablist">
              <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Proveedores selecionados</a></li>
              <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Proveedores favoritos</a></li>
          </ul>
        </div>
        <!-- Tab panes -->
      ...
      <div class="modal-body col-md-12">
        <div class="col-md-12">
          <p class="titulo-popoup">
            HAS <span>ACEP</span>TADO LA SOLICITUD DE:
          </p>
