          ...
          <div class="box-body">
            <section class="content padding-cero">
              ...
              <div class="row margin-tamano">
                    ...
                    <div class="box-body no-padding">
                      <div class="col-xs-12 col-md-12 lici-margin">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 box-footer no-padding separacion-lici mar-top">
                          <div class="col-xs-12 col-sm-12 col-md-12 mailbox-read-message justificado">
                            <p>
                ...
                <div class="col-xs-12 col-md-12 bottom-100 nomargin">
                    <div class="box-header">
                      <div class="box-footer1">
                        <div class="box-body no-padding">
                          <div class="col-xs-12 col-md-12 lici-margin">
                             ...
                             <div class="col-xs-12 col-md-12  izquierda left-lici">
                               <div class="col-xs-12 col-md-4 no-padding">
                                 <p class="nomargin asunto-licitacion1"><strong>costo:</strong>$30,000</p>
                                 <p class="nomargin asunto-licitacion1"><strong>Vigencia:</strong> 10 Mayo 2017 </p>
                               </div>
                               </div>
                             </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding separacion-lici mar-top">
                              <div class="col-xs-12 col-sm-12 col-md-12 mailbox-read-message justificado">
                                <p>
                                  Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim.<br><br>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12 box-footer1 box-top">
                      </div>
                    </div>
                </div>
                <!-- /.col -->
