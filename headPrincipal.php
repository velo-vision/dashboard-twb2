  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="reportes.php" class="logo hidden-xs">
        ...
        <span class="logo-lg"><img width="180px" src="images/recursos/logo-dash.jpg" alt="The Wedding Board"></span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <div class="hidden-sm hidden-md hidden-lg logo-mobile">
                <a href="muro-2.php"><img src="images/recursos/logo-dash.jpg" alt="The Wedding Board"></a>
              </div>
            </li>
          </ul>
        </div>
