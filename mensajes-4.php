        ...
        <div class="box-header with-border">            
          ...
          <div class="mailbox-read-info">                      
            ...
            <div class="mailbox-controls with-border">
              <div class="btn-group">
                <button type="button" class="btn btn-default btn-sm margin-mensajes btnmensaje1 botones-margin" data-toggle="tooltip" data-container="body" title="Delete">
                  <i class="fa fa-trash-o"></i> Borrar
                </button>
                <button type="button" class="btn btn-default btn-sm margin-mensajes btnmensaje2 botones-margin" data-toggle="tooltip" data-container="body" title="Reply">
