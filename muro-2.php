    ...
    <div class="col-md-7 col-md-offset-1">
      ...
      <div class="col-md-12 top-30">
        <div class="col-md-4 col-md-offset-4">
          <a href="editar-galeria.php">
            <p class="boton-ceremonia">
              <i class="fa fa-pencil-square-o" aria-hidden="true"></i> <span>Editar Galería</span>
            </p>
          </a>
        </div>
      </div>
    			...
    			<div class="sort-section top-10">
    				<div class="sort-section-container">
    					...
    					<ul class="list-inline">
    						<li><a href="#" data-filter="*" class="active">Galería 1</a></li>
    						<li><a href="#" data-filter=".restaurant">Galería 2</a></li>
    						<li><a href="#" data-filter=".bars">Galería 3</a></li>
    						<li><a href="#" data-filter=".pool">Galería 4</a></li>
    						<li><a href="#" data-filter=".rooms">Galería 5</a></li>
    						<li><a href="#" data-filter=".lobby">Galería 6</a></li>
    					</ul>
    				</div>
    			</div>
