                  ...
                  <div class="box box-primary top-30">
                    ...
                    <div class="box-body no-padding">
                      <div class="mailbox-read-info">
                        <h5><strong>Asunto:</strong> Cotización</h5>
                        <h5><strong>De:</strong> Matilde Obregón
                ...
                <div class="col-xs-12 col-md-12 bottom-100">
                  <div class="box collapsed-box">
                    <div class="box-header">
                      <!-- tools box -->
                      <div class="pull-right box-tools centers top-10">
                        <button type="button" class="btn btn-success btn-sm" data-widget="collapse">
                          <i class="fa fa-envelope-open-o" aria-hidden="true" style="margin-right:10px;"></i>Responder
                        </button>
