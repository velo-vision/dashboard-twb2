    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>
            <strong>Mónica Galindo</strong> </br>
            <small>moni.g@gmail.com</small>
          </p>
        </div>
      </div>
      <!--BOTONES PERFIL-->
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          ...
          <ul class="treeview-menu">
            <li class="">
              <a href="invitados-3.php">Mis invitados</a>
            </li>
          </ul>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu nomargin">
            ...
            <li class=""><a href="proveedores.php">¿Qué es una licitación?</a></li>
          </ul>
        </li>
        <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu nomargin">
            ...
            <li class=""><a href="proveedores.php">Mis proveedores</a></li>
          </ul>
        </li>
        <li class="treeview">
