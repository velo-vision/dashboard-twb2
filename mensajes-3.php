    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 top-20">
        <div class="box box-primary">
           <!-- /.box-header -->          
          <div class="box-header with-border padding-left-no">            
            <h3 class="box-title titulo-recibido"><span>RE: </span>Bienvenido a The Wedding Bible</h3>           
          </div>
          <!-- /.box-header -->
          ...
          <div class="box-footer">
            <div class="pull-right">
              ...
              <a href="mensajes-4.php"><button type="submit" class="btn btn-primary btn1">Enviar</button></a>
            </div>
